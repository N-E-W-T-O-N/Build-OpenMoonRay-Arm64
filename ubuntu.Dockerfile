...
# Build essentials
    build-essential \
    cmake meson tar unzip zip curl ccmake \
    ...
    patch \
    pybind11-dev \
    python3 python3-dev python3-full  python3-pip \
    wget \
...
ENV INSTALL_ROOT="/openmoonray/install/moonray"
ENV PATH="/openmoonray/install/moonray/bin:$PATH"
VOLUME /build
WORKDIR /source
